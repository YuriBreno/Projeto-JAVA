...
public class LoginUseer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoginUseer frame = new LoginUseer();
	...
	public void logar() {
		...
		try {
			...
			if(rs.next()) {
				TelaUsuario telaP = new TelaUsuario();
				telaP.setVisible(true);
				telaP.lblUsuario.setText(rs.getString(2));
				this.dispose();
	...
	public LoginUseer() {
		...
		JLabel lblNewLabel_1_2_1_1 = new JLabel("Cadastre-se");
		lblNewLabel_1_2_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				CadastraUseer c = new CadastraUseer();
				c.show();
				dispose();
		...
		lblNewLabel_1_2_1_1.setForeground(Color.GRAY);
		lblNewLabel_1_2_1_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_1_2_1_1.setBounds(31, 421, 120, 31);
		panel_1.add(lblNewLabel_1_2_1_1);
		
		JLabel lblNewLabel_1_2_1_1_1 = new JLabel("Esqueceu a senha?");
		lblNewLabel_1_2_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				AlterarSenhaUser as = new AlterarSenhaUser();
				as.show();
				dispose();
			}
		});
		lblNewLabel_1_2_1_1_1.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		lblNewLabel_1_2_1_1_1.setForeground(Color.GRAY);
		lblNewLabel_1_2_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_1_2_1_1_1.setBounds(31, 460, 187, 31);
